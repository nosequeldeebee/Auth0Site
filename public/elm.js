...
var _user$project$Commands$fetchHospitalsUrl = '/hospitals';
...
var _user$project$InitialModel$initialModel = {
	initialHospitals: {ctor: '[]'},
	refreshedHospitals: A2(
		_jschomay$elm_paginate$Paginate$fromList,
		1,
		_user$project$WebResponse$updateInitial(_krisajenkins$remotedata$RemoteData$Loading)),
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							searchedHospitals: _user$project$WebResponse$updateInitial(_p1)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Change':
						...
						model,
						{
							refreshedHospitals: A2(
								...
								A2(
									...
									_user$project$Update$refresh(_p2),
...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: _user$project$InitialModel$initialModel,
